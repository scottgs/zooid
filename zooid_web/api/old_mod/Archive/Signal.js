...
/**
 * Defines the heuristics for system muster control.
...
/**
 * Periodically checks the state of the system and updates
...
timers.setInterval(function muster(){
  ...
  System.find( { last_update: { "<" : senescence }})
    ...
    .exec(function(err, sigs) {
       ...
       * @param  {Array} sigs  [expired nodes array.]
       * @return null
       */
      ...
      _.map(sigs, function(sig){ 
        ...
        /**
         * Kill the signal.
         * @param  {Number}    sig.id  the id of the model instance to be destroyed.
